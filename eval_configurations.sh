...
function eval_model {
  ...
  #fi
  if [[ ! -f "${PYTHONPATH}/bin/eval_${1}_DT_${2}_${3}_KNN_${4}_${5}_${6}_DS_${8}/faulty_simple_square_test_nulled_volume/evaluation_continued_knn/log_true_vs_predicted.csv" ]]; then
