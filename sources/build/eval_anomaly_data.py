...
if __name__ == "__main__":
    ...
    for dt_config in dt_model_configs:
        ...
        anomaly_data = pickle.load(open(BIN_FOLDER_PATH + "/" + evaluation_name + "/evaluation_anomaly_data.pkl", "rb"))
        ...
        data_set_features = []
        for data_set_index in range(3, len(data.temporary_test_set_labels_dt)):
            for cycle in range(0, data.num_cycles):
                data_set_features = data_set_features + data.temporary_test_set_features_dt[data_set_index][cycle]
    ...
    for knn_config in knn_model_configs:
        ...
        for data_set_index in range(3, len(data.temporary_test_set_labels_dt)):
            for cycle in range(0, data.num_cycles):
                data_set_features = data_set_features + data.temporary_test_set_features_knn[data_set_index][cycle]
