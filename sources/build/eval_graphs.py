...
with open("/home/shino/Uni/master_thesis/bin/evaluation_data.pkl", 'rb') as file:
    ...
    with open("/home/shino/Uni/master_thesis/bin/evaluation_dt_model.pkl", 'rb') as file:
        ...
        GraphLocationMisclassification("evaluation_dt", model_dt, True, data.result_features_dt[0][19],
                                       data.result_labels_dt[0][19], data.num_outputs)
        GraphLocationMisclassification("evaluation_knn", model_knn, False, data.result_features_knn[0][19],
                                       data.result_labels_knn[0][19], data.num_outputs)

        GraphLocationMisclassifiedDistribution("evaluation_dt", model_dt, True, data.result_features_dt[0][19],
                                               data.result_labels_dt[0][19], data.num_outputs)
