...
plot_route("simple_square_anomaly_train1", "simple_square_anomaly_train1.csv")
plot_route("simple_square_anomaly_train2", "simple_square_anomaly_train2.csv")
plot_route("simple_square_anomaly_train3", "simple_square_anomaly_train3.csv")
plot_route("long_rectangle_anomaly_train1", "long_rectangle_anomaly_train1.csv")
plot_route("long_rectangle_anomaly_train2", "long_rectangle_anomaly_train2.csv")
plot_route("rectangle_with_ramp_anomaly_train1", "rectangle_with_ramp_anomaly_train1.csv")
plot_route("many_corners_anomaly_train1", "many_corners_anomaly_train1.csv")
