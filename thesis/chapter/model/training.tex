...
Anschließend wird einmalig einer Feature-Auswahl betrieben, in der insignifikante Features aus der Feature-Menge entfernt werden.
...
Klassifizierungsfehler erzeugen, wenn ihre Einträge in der Trainingsmenge permutiert werden \cite{breiman2001random}.
