...
Die Signifikanz der Features wird in dieser Arbeit definiert als der Fehler, der durch die Modifizierung eines Features in der Testmenge im Vergleich zur ursprünglichen Testmenge entsteht.
...
Die Klassifizierungsgenauigkeiten in Tabelle \ref{tab:predictions_by_acc_pic_cont} bestätigen diese Abhängigkeit.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{images/evaluation_feature_importance_dt_pi.png}
    \caption{Permutationswichtigkeit der Features eines Entscheidungswaldes.}
    \label{fig:feature_significance_dt}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{images/evaluation_feature_importance_knn_pi.png}
    \caption{Permutationswichtigkeit der Features eines FFNN.}
    \label{fig:feature_significance_knn}
\end{figure}
\newline
\newline
Für die Entscheidungswälder sind alle Features, bis auf den vorherigen Standort und die Standardabweichung von der Ausrichtung zum Magnetfeld, nach der Permutationswichtigkeit, unwichtig.
...
Dies zeigt den Nachteil der Permutationswichtigkeit auf.
Features, die durchweg sehr ähnlich, werden keinen großen Fehler durch die Permutation verursachen.
Aus diesem Grund sind Features auf Basis von Beschleunigung, Temperatur und Geräusche verhältnismäßig unwichtig.
\newline
\newline
Die Abhängigkeit zu den vorherigen Standorten ließe sich eliminieren, indem ohne die Rückwärtskante trainiert wird.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{images/fi_wo_fe_dt.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\linewidth]{images/fi_wo_fe_knn.png}
