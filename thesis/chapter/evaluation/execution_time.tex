...
Es ist aber anzunehmen, dass deutlich weniger Zyklen benötigt werden für hardwareunterstützte Gleitkommazahloperationen als Software basierte Alternativen.
...
sowie $\texttt{Waldgröße}\ \cdot\ \texttt{\#Standorte}$ Additionen und \text{\#Standorte} zusätzliche Vergleiche, um die einzelnen Entscheidungsbäume zusammenzufassen \cite{dymelThesis}.
