...
Insgesamt werden aber 34 Features verwendet, die vereinfacht alle als vier Byte Datentyp angenommen werden.
...
\newline
\newline
Zur Ausführung eines FFNN werden nur wenige Byte benötigt, um die nötigen Multiplikationen eines Neuronen durchzuführen.
...
Der maximale RAM, der zu einem Zeitpunkt benötigt wird mit einem FFNN, beträgt damit mindestestens $183 + 4(M + K)$ Byte,
